const gitExplain = () => {
  return (
    <div>
      ...
      <code>--Terminal: git add . //alle Dateien</code>
      <br />
      <code>--Terminal: git add [Datei] //bestimmte Dateien</code>
      <p>
      ...
      <br />
      <code>--Terminal: git checkout - //wechselt zum vorherigen Branch </code>
      <p>
        Um alle Branches anzuzeigen oder einen Branch zu löschen, führe die
        folgenden Befehle aus:
      </p>
      <code>--Terminal: git branch //zeigt alle Branches an </code>
      <code>--Terminal: git branch -d [Branch] //löscht einen Branch</code>
      <br />
      <h4>Merge</h4>
      ...
      <code>--Terminal: git remote -v //zeigt alle Remote-Repositories an</code>
      <br />
      <code>
      ...
      <code>--Terminal: git log //zeigt die Commit-Historie an</code>
      <br />
      <code>
      ...
      <pre>
        ...
        <code>git add .</code>
        <br />
        <code>git add [Datei]</code>
        <br />
        <code>git commit -m "Commit Message"</code>
        <br />
        <code>git commit -am "Add . und Commit Message in einem"</code>
        <br />
        <code>git checkout -b [neuer Branch]</code>
        <br />
        ...
        <br />
        <code>git Branch [neuer Branch]</code>
        <br />
        <code>git Branch -d</code>
        <br />
        <code>git merge [anderer Branch]</code>
        <br />
